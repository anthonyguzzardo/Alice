/**
 * Nightly job: generates tomorrow's question.
 * Days 1-30: skips — seed questions are pre-scheduled.
 * Day 31+: reads all responses, behavioral data, AI observations,
 *          and suppressed questions to generate the next question.
 *
...
if (responseCount < SEED_DAYS) {
  console.log(`Day ${responseCount + 1} of seed phase. No generation needed.`);
  process.exit(0);
}

// Day 31+: generate from full context
