...
export function buildSessionSummary(
  ...
  return {
    ...
    // Phase 1 expansion signals — null for simulation
    confirmationLatencyMs: null,
    pasteCount: null,
    pasteCharsTotal: null,
    readBackCount: null,
    leadingEdgeRatio: null,
    contextualRevisionCount: null,
    preContextualRevisionCount: null,
    consideredAndKeptCount: null,
    holdTimeMeanLeft: null,
    holdTimeMeanRight: null,
    holdTimeStdLeft: null,
    holdTimeStdRight: null,
    holdTimeCV: null,
    negativeFlightTimeCount: null,
    ikiSkewness: null,
    ikiKurtosis: null,
    errorDetectionLatencyMean: null,
    terminalVelocity: null,
    // Phase 2 expansion signals — null for simulation
    cursorDistanceDuringPauses: null,
    cursorFidgetRatio: null,
    cursorStillnessDuringPauses: null,
    driftToSubmitCount: null,
    cursorPauseSampleCount: null,
    deletionExecutionSpeedMean: null,
    postcorrectionLatencyMean: null,
    meanRevisionDistance: null,
    maxRevisionDistance: null,
    punctuationFlightMean: null,
    punctuationLetterRatio: null,
  };
}
