# Alice Marketing: Differentiation-Led Campaign System

## The Position

Alice occupies a quadrant no other product occupies: **learns from user history, never surfaces it back.** Every competitor either shows you what it learned (Rosebud, Daylio, WHOOP) or doesn't learn at all (Drift, Halka, Presently). This is the moat. It is philosophical, not technical.
...
│
├── defense/               Military and intelligence community
│   └── campaign-brief.md     Cognitive readiness you can't fake.
│
...
Alice appears differently to each market, but the architecture is the same:

| Market | User Sees | Buyer Gets |
|---|---|---|
...
| Aging | Daily thinking practice | Cognitive trajectory monitoring with dignity |

The user always experiences a journal. The value layer above varies by buyer.

## Competitive Landscape Summary

Research covered 40+ products across six categories. Key findings:

**AI Journaling** (Rosebud, Reflection, Life Note, Mindsera): All surface insights back, creating feedback loops that eventually feel circular. Alice breaks the loop.

**Mood Trackers** (Daylio, Bearable, How We Feel): Capture what/when, never why. Alice only asks why.
