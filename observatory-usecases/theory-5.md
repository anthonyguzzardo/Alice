...
### The Neurodegenerative Evidence Is Stronger Than Theory 4 Stated

Two findings from the 2025-2026 literature significantly strengthen the clinical case:

**1. Li et al. (2025, Frontiers in Computational Neuroscience):** Writing process digital biomarkers for community cognitive screening achieved **AUC = 0.918**, outperforming both MoCA and MMSE on the same population. This is the first published study demonstrating that writing process signals beat the gold-standard cognitive screening tests. The features used: writing speed, pause frequency, stroke pressure, within-word and between-word intervals.
...
The clinical evidence base for writing + cognition is stronger than the consumer market data:

- **Li et al. (2025):** Writing process digital biomarkers for community screening: AUC = 0.918, beating MoCA and MMSE.
- **Meulemans, Van Waes, Leijten (2022, University of Antwerp):** Inputlog keystroke logging in AD — 108 fewer chars/min, 20.6% more pause time in cognitively impaired writers. Very large effect sizes.
- **Nun Study 30-Year Follow-Up (2025, UT Health San Antonio):** Idea density still predictive of neuropathological outcomes across 6+ decades.
...
"You funded SpeechDx — a standardized speech dataset for AD biomarker development, now licensed by Siemens Healthineers. Writing is the complementary modality that doesn't exist yet. Li et al. (2025) showed writing process biomarkers achieve AUC 0.918 for cognitive screening, beating MoCA and MMSE. I have the capture infrastructure. Could a WritingDx dataset fill the same gap for written language that SpeechDx fills for spoken?"
